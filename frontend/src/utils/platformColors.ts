...
const BADGE: Record<Platform, string> = {
  ...
  kiro: 'bg-amber-500/10 text-amber-700 border-amber-500/30 dark:text-amber-300',
  qoder: 'bg-violet-500/10 text-violet-700 border-violet-500/30 dark:text-violet-300',
  codebuddy: 'bg-sky-500/10 text-sky-700 border-sky-500/30 dark:text-sky-300',
  'codebuddy-china': 'bg-red-500/10 text-red-700 border-red-500/30 dark:text-red-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  kiro: 'bg-amber-500/10 text-amber-700 dark:bg-amber-500/10 dark:text-amber-300',
  qoder: 'bg-violet-500/10 text-violet-700 dark:bg-violet-500/10 dark:text-violet-300',
  codebuddy: 'bg-sky-500/10 text-sky-700 dark:bg-sky-500/10 dark:text-sky-300',
  'codebuddy-china': 'bg-red-500/10 text-red-700 dark:bg-red-500/10 dark:text-red-300',
...
const BORDER: Record<Platform, string> = {
  ...
  qoder: 'border-violet-500/20 dark:border-violet-500/20',
  codebuddy: 'border-sky-500/20 dark:border-sky-500/20',
  'codebuddy-china': 'border-red-500/20 dark:border-red-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  qoder: 'border-violet-500/35 dark:border-violet-500/30',
  codebuddy: 'border-sky-500/35 dark:border-sky-500/30',
  'codebuddy-china': 'border-red-500/35 dark:border-red-500/30',
...
const ACCENT: Record<Platform, string> = {
  ...
  qoder: '#8b5cf6', // violet-500
  codebuddy: '#0ea5e9', // sky-500
  'codebuddy-china': '#ef4444', // red-500
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  qoder: 'bg-gradient-to-r from-violet-400 to-violet-500',
  codebuddy: 'bg-gradient-to-r from-sky-400 to-sky-500',
  'codebuddy-china': 'bg-gradient-to-r from-red-400 to-red-500',
...
const TEXT: Record<Platform, string> = {
  ...
  kiro: 'text-amber-700 dark:text-amber-300',
  qoder: 'text-violet-700 dark:text-violet-300',
  codebuddy: 'text-sky-700 dark:text-sky-300',
  'codebuddy-china': 'text-red-700 dark:text-red-300',
...
const ICON: Record<Platform, string> = {
  ...
  kiro: 'text-amber-500 dark:text-amber-300',
  qoder: 'text-violet-500 dark:text-violet-300',
  codebuddy: 'text-sky-500 dark:text-sky-300',
  'codebuddy-china': 'text-red-500 dark:text-red-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  qoder: 'bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700 dark:bg-violet-500/80 dark:hover:bg-violet-500',
  codebuddy: 'bg-sky-500 text-white hover:bg-sky-600 active:bg-sky-700 dark:bg-sky-500/80 dark:hover:bg-sky-500',
  'codebuddy-china': 'bg-red-500 text-white hover:bg-red-600 active:bg-red-700 dark:bg-red-500/80 dark:hover:bg-red-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  kiro: 'bg-amber-100 text-amber-800 dark:bg-amber-900/40 dark:text-amber-300',
  qoder: 'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300',
  codebuddy: 'bg-sky-100 text-sky-800 dark:bg-sky-900/40 dark:text-sky-300',
  'codebuddy-china': 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  qoder: 'from-violet-500 to-violet-600',
  codebuddy: 'from-sky-500 to-sky-600',
  'codebuddy-china': 'from-red-500 to-red-600',
...
const GRADIENT_TEXT: Record<Platform, string> = {
  ...
  kiro: 'text-amber-100',
  qoder: 'text-violet-100',
  codebuddy: 'text-sky-100',
  'codebuddy-china': 'text-red-100',
...
const GRADIENT_SUBTEXT: Record<Platform, string> = {
  ...
  kiro: 'text-amber-200',
  qoder: 'text-violet-200',
  codebuddy: 'text-sky-200',
  'codebuddy-china': 'text-red-200',
...
export function platformLabel(p: string): string {
  switch (p) {
    ...
    case 'codebuddy-china': return 'CodeBuddy China'
