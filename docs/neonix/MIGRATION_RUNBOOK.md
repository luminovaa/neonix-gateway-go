...
Codex and Grok device login, and Antigravity OAuth callback-paste login are
available there; the middleware
...
The compatibility surface is a staged cutover boundary. M365, remaining
