...
| API keys (`/api/api-keys`) | Node compatibility | Go compatibility slice available; legacy-id mapping migration added | key import, default-key bootstrap, create/delete, usage/access smoke test |
