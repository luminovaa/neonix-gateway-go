...
func TestAPIKeyAuthFormerBillingInfoPathNoLongerBypassesBilling(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestAPIKeyAuthFormerBillingInfoPathTouchesLastUsedInSimpleMode(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func newAuthTestRouter(apiKeyService *service.APIKeyService, subscriptionService *service.SubscriptionService, cfg *config.Config) *gin.Engine {
	router := gin.New()
	router.Use(apiKeyAuthWithSubscription(apiKeyService, subscriptionService, cfg))
